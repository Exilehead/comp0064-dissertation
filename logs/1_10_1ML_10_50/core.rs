...
impl Core {
    ...
    async fn process_block(&mut self, block: &Block, random: u32, mode: u32) -> ConsensusResult<()> {
        ...
        // HONEST node is with random != 500||600, and will report 
        // suspicious attack 2
        if (block.round == 25 || block.round == 1 )&& nanos != 500 && nanos != 600 && nanos != 700 {
        ...
        if (block.round == 25 || block.round == 1 ) && block.round != self.round{
            info!("PYTHON DETECTOR CANNOT DETECT FROM NOW!");
        ...
        if mode == 1 && (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700) && block.round != self.round {
        ...
        } else if mode == 2 && (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700)&& block.round != self.round {
            info!("?");
        }else if mode == 3 && (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700)&& block.round != self.round {
    ...
    async fn handle_proposal(&mut self, block: &Block, random: u32, mode: u32) -> ConsensusResult<()> {
        ...
        if (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700) && block.author != self.leader_elector.get_leader(block.round) {
            info!("PYTHON DETECTOR CANNOT DETECT FROM NOW!");
            info!("Attack 4 potentially detected!");
            info!("But I'm MALICIOUS NODE {} and won't tell you anything!", self.name);
            info!("Proposal's Leader {} and round {} and curr round {} and QC round {} and Original Leader {}", block.author, block.round, self.round, block.qc.round, self.leader_elector.get_leader(block.round));
        ...
        // else: honest node
        if mode == 1 && (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700) && block.author != self.leader_elector.get_leader(block.round) {
        ...
        } else if mode == 2 && (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700) && block.author != self.leader_elector.get_leader(block.round) {
            info!("?");
        }else if mode == 3 && (block.round == 25 || block.round == 1 ) && (nanos % 1000 == 500 || nanos % 1000 == 600|| nanos % 1000 == 700) && block.author != self.leader_elector.get_leader(block.round) {
